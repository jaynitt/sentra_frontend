...
const projectsData: Project[] = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1551288049-bebda4e38f71?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkYXRhJTIwYW5hbHl0aWNzJTIwZGFzaGJvYXJkfGVufDF8fHx8MTc2OTMwMTk4N3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1590286162167-70fb467846ae?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxibG9ja2NoYWluJTIwY3J5cHRvY3VycmVuY3l8ZW58MXx8fHwxNzY5MjcwMzAyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  },
  {
    ...
    description:
      "Multi-source sentiment aggregation platform combining news, social media, and expert analysis for comprehensive market views.",
    link: "https://example.com/sentimentx",
    image:
      "https://images.unsplash.com/photo-1606857521015-7f9fcf423740?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZWNobm9sb2d5JTIwc3RhcnR1cCUyMG9mZmljZXxlbnwxfHx8fDE3NjkyOTM2MjZ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  },
  {
    ...
    description:
      "Real-time market pulse monitoring system tracking volume, volatility, and sentiment shifts across all major exchanges.",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1674027444485-cec3da58eef4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcnRpZmljaWFsJTIwaW50ZWxsaWdlbmNlJTIwbmV0d29ya3xlbnwxfHx8fDE3NjkzMjc4ODB8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  const isInternal = project.link.startsWith("/"); // ✅ ONLY LOGIC ADDED
    ...
    >
      ...
      <div className="p-6">
        ...
        {isInternal ? (
          ...
          <Link
            to={project.link}
            className="flex items-center justify-center gap-2 w-full px-4 py-3 bg-gradient-to-r from-orange-600 to-orange-500 text-white rounded-lg"
          >
            View Project
